...
#
# Created: Thu Sep 26 11:17:22 2019
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.step_filter_lab.setText(
            QtGui.QApplication.translate("Form", "Filter by Task step", None, QtGui.QApplication.UnicodeUTF8))
        self.shot_tab_widget.setTabText(self.shot_tab_widget.indexOf(self.tab_shot),
                                        QtGui.QApplication.translate("Form", "Shot", None,
                                                                     QtGui.QApplication.UnicodeUTF8))
        self.shot_tab_widget.setTabText(self.shot_tab_widget.indexOf(self.tab2),
                                        QtGui.QApplication.translate("Form", "...", None,
                                                                     QtGui.QApplication.UnicodeUTF8))
        self.step_sel_all.setText(
        ...
        self.load_all_btn.setText(
            QtGui.QApplication.translate("Form", "Load All", None, QtGui.QApplication.UnicodeUTF8))
        self.load_sel_btn.setText(
            QtGui.QApplication.translate("Form", "Load Selection", None, QtGui.QApplication.UnicodeUTF8))